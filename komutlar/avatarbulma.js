...
if (mention != null || mention != undefined) {
  ...
  .addField('Avatar Sistemi', `[Avatarin buyuk halini goster!](${mention.avatarURL})`, false);
  message.react("����");
  ...
  .addField('Avatar Sistemi', `[Avatarin buyuk halini goster!](${message.author.avatarURL})`, false);
